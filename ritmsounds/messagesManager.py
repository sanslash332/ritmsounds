...
_defaultMessages = {
    ...
    'selectwindow:help2': 'Selección de dificultad. Seleccione qué dificultad de esta canción desea jugar. luego precione enter',
    ...
    'testwindow:help': 'Pantalla de prueba de sonidos. para conocer los sonidos que equivalen a cada una de las teclas, utilize %0, %1, %2 y  %3 en la mano izquierda, y %4, %5, %6 y %7, en la mano derecha. También puede recorrer el menú con abajo y arriba, y active las opciones con enter. Para regresar al menú principal, presione escape.',
